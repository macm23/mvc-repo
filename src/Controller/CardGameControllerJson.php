...
class CardGameControllerJson
{
    ...
    public function jsonDeckShufflePost(Request $request, SessionInterface $session
    ): Response
    {
    $cardRoll = [];
    for ($i = 1; $i <= 52; $i++) {
...
public function jsonDeckDraw(Request $request, SessionInterface $session
): Response
{
    $cardRoll = [];
...
public function jsonDeckDrawMultiple(Request $request, SessionInterface $session
): Response
{
...
public function drawJsonGet(Request $request,
    SessionInterface $session, $num
): Response
{
